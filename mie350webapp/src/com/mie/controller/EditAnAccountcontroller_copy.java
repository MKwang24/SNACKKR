 ...
 */
public class EditAnAccountcontroller_copy extends HttpServlet {
...
//				session.setAttribute("yearofbirth", member.getYearofBirth());
//				session.setAttribute("sex", member.getLastName());
